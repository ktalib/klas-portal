...
<div class="relative">
    ...
    <div class="relative bg-green-700">
        <div class="absolute inset-0">
            <img src="https://i0.wp.com/kanostate.gov.ng/wp-content/uploads/2024/08/Kano.jpg?fit=1024%2C640&ssl=1" alt="Kano City Aerial View" class="w-full h-full object-cover opacity-30">
        </div>
