<footer class="bg-green-800 text-white">
    <div class="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                <h3 class="text-sm font-semibold text-yellow-300 tracking-wider uppercase mb-4">Quick Links</h3>
                <ul class="space-y-2">
                    <li><a href="{{ route('home') }}" class="text-gray-200 hover:text-white">Home</a></li>
                    <li><a href="{{ route('about') }}" class="text-gray-200 hover:text-white">About Us</a></li>
                    <li><a href="{{ route('services') }}" class="text-gray-200 hover:text-white">Services</a></li>
                    <li><a href="{{ route('legal-search') }}" class="text-gray-200 hover:text-white">Legal Search</a></li>
                    <li><a href="{{ route('webmap') }}" class="text-gray-200 hover:text-white">Webmap</a></li>
                </ul>
            </div>
            <div>
            ...
            <div>
                <h3 class="text-sm font-semibold text-yellow-300 tracking-wider uppercase mb-4">Contact Us</h3>
                <address class="not-italic text-gray-200 space-y-2">
                    <p>Ministry of Land and Physical Planning</p>
                    <p>Kano State Secretariat</p>
                    <p>Kano, Nigeria</p>
                    <p class="mt-4">Email: info@kangis.gov.ng</p>
                    <p>Phone: +234 (0) 123 456 7890</p>
                </address>
            </div>
        </div>
        <div class="mt-8 border-t border-green-700 pt-8 flex flex-col md:flex-row justify-between">
            <p class="text-base text-gray-300">&copy; {{ date('Y') }} KANGIS. All rights reserved.</p>
